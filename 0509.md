...
$$
\begin{align}
\frac{\partial ^Y \log\ p(Y \mid \theta)}{\partial \theta ^2} &= \frac{\partial}{\partial \theta} \Big( \frac{Y}{\theta} - 1 \Big) \\
&= - \frac{Y}{\theta ^2}
\end{align} \tag{14}
$$
...
$$
\begin{align}
I(\theta) &= -E\Big[ \frac{\partial ^Y \log\ p(Y \mid \theta)}{\partial \theta ^2} \mid \theta \Big] \\
